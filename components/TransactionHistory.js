...
const style = {
  ...
  txHistoryItem: `bg-[#ffffff] text-[#00000c] text-[#cbcbcb] rounded-lg px-4 py-2 my-2 flex items-center justify-end`,
  txDetails: `flex items-center`,
  toAddress: `text-[#985179] mx-2`,
  txTimestamp: `mx-2 text-[#cbcbcb]`,
